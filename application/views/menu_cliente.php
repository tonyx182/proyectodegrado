...
<body>
    ...
    <div class="sidebar close">        
        ...
        <ul class="nav-links">
        <li>
            <a href="<?php echo site_url('usuario/menuCliente');?>">
            <i class='bx bx-grid-alt' ></i>
            <span class="link_name">Inicio</span>
            </a>
            <ul class="sub-menu blank">
            <li><a class="link_name" href="<?php echo site_url('usuario/menuCliente');?>">Inicio</a></li>
            </ul>
        </li>        
        <!------ <li>
            <div class="iocn-link">
        ...
        <li>
            <a href="<?php echo site_url('pasajero/modificar');?>">
            <i class='bx bx-cog' ></i>
            <span class="link_name">Configuración <br> de la Cuenta</span>
            </a>
            <ul class="sub-menu blank">
                <li><a class="link_name" href="<?php echo site_url('pasajero/modificar');?>">Configuración Cuenta</a></li>
            </ul>
        </li>
        <?php
