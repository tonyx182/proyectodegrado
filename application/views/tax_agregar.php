...
<body>    
    ...
    <main>
        ...
        <h1>Formulario de Registro de Taxistas</h1>

        <form role="form" action="<?php echo site_url('usuario/agregarTaxistabd');?>" class="formulario" id="formulario" method="post">

            <?php
                echo form_open_multipart('usuario/agregarTaxistabd');
            ?>     
            ...
            <div class="formulario__grupo" id="grupo__nroLicencia">
                <label for="nroLicencia" class="formulario__label">Número de Liciencia de Conducir</label>
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="nroLicencia" id="nroLicencia" placeholder="">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
                <p class="formulario__input-error"></p>
            </div>
